...
# package
import my_awesome_plugin.toolbelt.log_handler as log_hdlr
from my_awesome_plugin.__about__ import __title__, __version__
from my_awesome_plugin.toolbelt.env_var_parser import EnvVarParser

# ############################################################################
# ########## Classes ###############
# ##################################

PREFIX_ENV_VARIABLE = "QGIS_MY_AWESOME_PLUGIN_"
